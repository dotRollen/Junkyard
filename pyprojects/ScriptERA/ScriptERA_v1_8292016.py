...
##        ----------------------***----------------------              ##
##                                                                     ##
## Change log [8/29/2016]:                                             ##
##                                                                     ##
##     Script now supports openpyxl and uses nodels to list nodes      ##
##     dynamically, instead of a static txt file. After pinging        ##
##     the nodes succesfully it will now create a xlsx workbook,       ##
##     which has information gathered from racadm for the model,       ##
...
ws1 = wb.active
ws1.title = "Ashburn"
dest_filename = project + '_' + location + '_' + rackrange + '_EDI_Template_Final' + timestr + '.xlsx'
